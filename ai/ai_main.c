...
void AI_PickLongRangeGoal(edict_t* self)
{
	...
	float	cost;
	int nearest = -1;
	float temp_distance, nearest_distance = 9999999; /* , nearest_distanceb = 9999999; MetalGod initialized, but not referenced */
	vec3_t distb;

	int j, randseed, k;

	/* edict_t* closest = NULL; MetalGod initialized, but not referenced */
	edict_t* e = NULL;
